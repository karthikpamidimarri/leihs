...
ActiveRecord::Schema.define(version: 20161221075137) do
  ...
  add_index "hidden_fields", ["field_id"], name: "fk_rails_3dac013d86", using: :btree
  add_index "hidden_fields", ["user_id"], name: "fk_rails_00a4ef0c4f", using: :btree
  ...
  add_index "mail_templates", ["inventory_pool_id"], name: "fk_rails_5d00b5b086", using: :btree
  add_index "mail_templates", ["language_id"], name: "fk_rails_3e8b923972", using: :btree
